        ...
        <>
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                <Paper style={{ backgroundColor: "FFFFFF" }}>
                    <Stack bgcolor={"#FAFDFD"} borderRadius={2} direction={"row"} spacing={"16px"} padding={"16px"} alignItems={"center"}>
                        <img src="" alt="" />
                    </Stack>
                </Paper >
                <Paper>
                ...
                <Paper>
                    <Stack marginBottom={"20px"} bgcolor={"#FAFDFD"} borderRadius={2} direction={"row"} spacing={"16px"} padding={"16px"} alignItems={"center"}>
                        <Box>
                            <Typography gutterBottom component="h5" style={{ color: "#000000", fontFamily: "Roboto", fontSize: "16px", fontWeight: 600 }} >
